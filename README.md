...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/burau-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14050&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/burau-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `burau` can be installed with:

```
conda install burau
```

It is possible to list all of the versions of `burau` available on your platform with:
